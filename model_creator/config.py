...
# statistics
NUMBER_EPOCH_TAKEN_COMPARISON = 5 # for comparison of all models, only used for epoch heatmap
NUMBER_COMPARISON = 100 #in each case of each heatmap, that amount of comparison will be made
...
# continuous movement
CONTINUOUS_MOVEMENT_LENGTH = 200
