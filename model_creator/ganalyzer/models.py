...
MODEL_CONFIGS_64 = _clone_configs(BASE_CONFIGS_64)
MODEL_CONFIGS_80 = _clone_configs(BASE_CONFIGS_64)
MODEL_CONFIGS_100 = _clone_configs(BASE_CONFIGS_64)
...
def get_discriminator():
	...
	step = 0
	while cur > 4:
		x = layers.Conv2D(_filters_for_disc(step, cfg["disc_seq"]), kernel_size = 5, strides = 2, padding = "same")(x)
