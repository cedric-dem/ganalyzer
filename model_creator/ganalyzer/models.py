...
MODEL_CONFIGS_64 = {
        ...
        "model_2_medium": _make_config(
                gen_base = [448, 224, 112, 56, 28, 14],
                gen_min = 14,
                disc_seq = [56, 112, 224, 448, 448, 448],
...
MODEL_CONFIGS_80 = {
        ...
        "model_1_small": _make_config(
                gen_base = [432, 216, 108, 54, 27, 13],
                gen_min = 13,
                disc_seq = [54, 108, 216, 432, 432, 432],
                disc_fc = lambda image_size: [image_size * 3],
                gen_ch0 = 432,
                gen_pre_dense = [640],
                extra_conv = True,
        ...
        "model_2_medium": _make_config(
                gen_base = [504, 252, 126, 63, 32, 16],
                gen_min = 16,
                disc_seq = [63, 126, 252, 504, 504, 504],
...
MODEL_CONFIGS_100 = {
        ...
        "model_2_medium": _make_config(
                gen_base = [560, 280, 140, 70, 35, 18],
                gen_min = 18,
                disc_seq = [70, 140, 280, 560, 560, 560],
                disc_fc = lambda image_size: [image_size * 4, image_size * 2],
                gen_ch0 = 560,
                gen_pre_dense = [1024],
                extra_conv = True,
...
MODEL_CONFIGS_114 = {
        ...
        "model_1_small": _make_config(
                gen_base = [528, 264, 132, 66, 33, 17, 17],
                gen_min = 17,
                disc_seq = [66, 132, 264, 528, 528, 528, 528],
                disc_fc = lambda image_size: [128],
                gen_ch0 = 528,
                extra_conv = True,
        ),
        "model_2_medium": _make_config(
                gen_base = [616, 308, 154, 77, 38, 20, 20],
                gen_min = 20,
                disc_seq = [77, 154, 308, 616, 616, 616, 616],
...
MODEL_CONFIGS_120 = {
        ...
        "model_1_small": _make_config(
                gen_base = [576, 288, 144, 72, 36, 18, 18],
                gen_min = 18,
                disc_seq = [72, 144, 288, 576, 576, 576, 576],
                disc_fc = lambda image_size: [144],
                gen_ch0 = 576,
                extra_conv = True,
        ),
        "model_2_medium": _make_config(
                gen_base = [672, 336, 168, 84, 42, 21, 21],
                gen_min = 21,
...
MODEL_CONFIGS_128 = {
        ...
        "model_1_small": _make_config(
                ...
                disc_fc = lambda image_size: [160],
                gen_ch0 = 640,
                extra_conv = True,
        ),
        "model_2_medium": _make_config(
                gen_base = [752, 376, 188, 94, 47, 24, 24],
                gen_min = 24,
                disc_seq = [94, 188, 376, 752, 752, 752, 752],
                disc_fc = lambda image_size: [256],
                gen_ch0 = 752,
                gen_pre_dense = [768],
                extra_conv = True,
...
MODEL_CONFIGS_240 = {
        ...
        "model_2_medium": _make_config(
                gen_base = [640, 432, 320, 216, 160, 104],
                gen_min = 104,
                disc_seq = [112, 216, 320, 432, 640, 640],
                disc_fc = lambda image_size: [image_size * 5, image_size * 2],
                gen_ch0 = 896,
                gen_pre_dense = [1792],
                extra_conv = True,
        ),
